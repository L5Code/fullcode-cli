...
- fullcode create
  ![fullcode-create](https://i.loli.net/2021/04/22/F7o1BUSfzPIT2Xn.gif)
- fullcode add
  ![fullcode-add](https://i.loli.net/2021/04/22/9CZ5qrnAzmJB1HX.gif)
...
> 本项目是一套可以定制的、统一的项目开发解决方案，你深入学习，根据本基础方案衍申开发更多其他功能。
